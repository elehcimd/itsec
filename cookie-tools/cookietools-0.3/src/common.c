/*
 * common.c by xenion -- Sun Nov 18 21:40:03 CET 2007
 *
...
int strnstr(char *str1, char *str2, int str1len)
{
  int str2len, i;
...
void
logmem(u_int8_t *p, u_int32_t len, u_int32_t cols, int format)
{
  ...
  LOG(1,0," + Dumping memory from %p for %d bytes, cols: %d, fmt: ",p,len, cols);
